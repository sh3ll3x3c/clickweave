...
fn test_planner_prompt_includes_tools() {
    ...
    let prompt = planner_system_prompt(&tools, false, false, None, None, false, None, false);
...
fn test_planner_system_prompt_with_all_features() {
    let prompt = planner_system_prompt(&[], true, true, None, None, false, None, false);
...
fn test_planner_prompt_includes_control_flow() {
    let prompt = planner_system_prompt(&[], false, false, None, None, false, None, false);
    assert!(
