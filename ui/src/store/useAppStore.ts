...
export function useAppStore(): [AppState, AppActions] {
  ...
  const state: AppState = {
    ...
    supervisionPause: store.supervisionPause,
  ...
  const actions: AppActions = {
    ...
    setSupervisionPause: store.setSupervisionPause,
    clearSupervisionPause: store.clearSupervisionPause,
    supervisionRespond: store.supervisionRespond,
