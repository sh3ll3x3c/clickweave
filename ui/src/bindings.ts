...
export type RunEventsQuery = { project_path: string | null; workflow_id: string; node_id: string; run_id: string }
...
export type RunsQuery = { project_path: string | null; workflow_id: string; node_id: string }
